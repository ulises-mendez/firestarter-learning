...
export default({index,lesson, section}) => {
    ...
    const [premium, setPremium] = React.useState(lesson.premium)
    console.log(lesson.premium)
        ...
        <div className='w-full p-4 border-b'>
            <div onClick={() => setDropdown(!dropdown)} className='cursor-pointer w-full text-left flex items-center justify-between'>
                <div className='flex items-center'>
                    ...
                    <h4>{lesson.title} <span className='text-xs text-gray-400'>{lesson.premium == true ? 'Premium Lesson' : ''}</span></h4>
                </div>
