...
const QuizQuestion = () =>{
    const { acknowledged, course, finished, quiz, quiz_question, question, questions } = usePage().props
    ...
    return(
        ...
        <div className='w-full h-full flex items-stretch'>
            ...
            </div>
            {
                ...
                <div>
                    {
                        question.options.map(
                            ...
                            key={i}>
                                ...
                                //htmlFor={option.text}
                                >
                                <div className={`border rounded-full w-4 h-4 flex items-center justify-center mr-2 ${option.id == acknowledged.id ? acknowledged.value == 1 ? 'bg-green-600 border-green-600' : 'bg-red-600 border-red-600' : ''}`}>
                                    {
                                        option.id == acknowledged.id ?
                    ...
                    <div className='mt-4 text-right'>
                        {
                            ...
                            :
                            <InertiaLink  href={route('course.quiz', [course.slug, quiz.id])}>
                                <button className='btn-orange'>Next </button>
                            </InertiaLink>
                        }
                    </div>
                ...
                :
                <div className='bg-gray-100 mx-auto p-4 rounded-lg'>
