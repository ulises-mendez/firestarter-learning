                    ...
                    <div className='w-full py-4'>
                        <div className='max-w-3xl mx-auto'>
                            <div className='leading-relaxed text-gray-500'>
                                <span className='cursor-pointer mx-1 relative hover:underline group hover:text-black'>- Are you looking to launch a business <div className='absolute toptranscipt -top-8 left-1/2 -translate-x-1/2 bg-black bg-opacity-75 text-white px-2 opacity-100 group-hover:opacity-100 group-hover:block'><div>Jump to 0:00</div></div></span>
